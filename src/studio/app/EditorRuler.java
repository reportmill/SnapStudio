 ...
 */
public class EditorRuler extends View {
 ...
 */
public EditorRuler(Editor owner, byte orientation)
{
    _editor = owner;
...
{
    double unitWidth = 72;//_unitOfMeasure==RMDocument.Unit.CM || _unitOfMeasure==RMDocument.Unit.MM? 57 : 72;
