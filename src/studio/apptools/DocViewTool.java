...
/**
 * This class provides UI for configuring a DocView.
 */
public class DocViewTool <T extends DocView> extends ViewTool <T> {
 ...
 */
public boolean childrenSuperSelectImmediately(View aShape)  { return true; }
...
protected void initUI()
{
    ...
    View pscb = getView("PaperSizeComboBox");
...
public void resetUI()
{
    ...
    DocView doc = getSelectedShape(); if(doc==null) return;
...
public void respondUI(ViewEvent anEvent)
{
    ...
    // Handle UnitComboBox
    //if(anEvent.equals("UnitComboBox")) doc.setUnit((RMDocument.Unit)anEvent.getValue());
...
public static class PageSizeView extends View {
    public void paintFront(Painter aPntr) {
        DocViewTool docTool = getOwner(DocViewTool.class);
        Editor editor = docTool.getEditor();
        Size pageSize = new Size(792,612);//editor.getDocument().getPageSize();
