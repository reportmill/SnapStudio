 ...
 */
public class BoneViewTool <T extends BoneView> extends ViewTool <T> {
...
public void resetUI()
{
    ...
    BoneView rect = getSelectedView(); if(rect==null) return;
 ...
 */
public Class getViewClass()  { return BoneView.class; }
